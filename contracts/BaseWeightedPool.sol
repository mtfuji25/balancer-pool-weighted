...
interface IBaseWeightedPool {
    function calculateExactTokensInForBPTOut(
 ...
 */
abstract contract BaseWeightedPool is IBaseWeightedPool, BaseMinimalSwapInfoPool {
     ...
     */
    function getNormalizedWeightsAndMaxWeightIndex() public view override virtual returns (uint256[] memory, uint256);
    ...
    function getInvariant() public view returns (uint256) {
        ...
        (uint256[] memory normalizedWeights, ) = getNormalizedWeightsAndMaxWeightIndex();
        ...
        )
    {
        ...
        (uint256[] memory normalizedWeights, uint256 maxWeightTokenIndex) = getNormalizedWeightsAndMaxWeightIndex();
    ...
    function calculateExactTokensInForBPTOut(
        ...
        _calculateExactTokensInForBPTOut(balances, normalizedWeights, scalingFactors, userData);
    }

    function _calculateExactTokensInForBPTOut(
        uint256[] memory balances,
        uint256[] memory normalizedWeights,
        uint256[] memory scalingFactors,
        bytes memory userData
