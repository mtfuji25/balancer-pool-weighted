...
interface IWeightedPool {
    function getWeightedPoolScalingFactors() external view returns (uint256[] memory);
}
...
contract WeightedPool is IWeightedPool, BaseWeightedPool {
    ...
    function getNormalizedWeightsAndMaxWeightIndex()
        public
        view
        virtual
        override
    ...
    function getWeightedPoolScalingFactors() external override view returns (uint256[] memory) {
